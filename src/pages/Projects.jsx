								...
								<ul className='row'>
									...
									<li className='carousel-card'>
										<a className='col center' href='https://buzzvel.com/portfolio/viplant' target='_blank' rel="noreferrer" title='Viplant' >
											<img className='carousel-card-img' src='../assets/img/viplant.webp' alt='Viplant: We created a new website for VIPLANT with the main aim of enhancing the user experience, extending the quality of the physical purchase to the digital environment.' />
									...
									<li className='carousel-card'>
										<a className='col center' href='https://buzzvel.com/portfolio/traquinices' target='_blank' rel="noreferrer" title='Traquinices' >
											<img className='carousel-card-img' src='../assets/img/traquinices.webp' alt='Traquinices: Traquinices is a company that was born in Portugal in 1996. It specializes in the distribution of premium Childcare products to provide the best satisfaction to customers.' />
											<div className='col gap-sm pad-md carousel-card-text'>
									...
									<li className='carousel-card'>
										<a className='col center' href='https://buzzvel.com/portfolio/dbs' target='_blank' rel="noreferrer" title='DBS' >
											<img className='carousel-card-img' src='../assets/img/dbs.webp' alt='DBS: We built this platform and APP that allowed primary users to track medical tests.' />
											<div className='col gap-sm pad-md carousel-card-text'>
									...
									<li className='carousel-card'>
										<a className='col center' href='https://buzzvel.com/portfolio/miss-can' target='_blank' rel="noreferrer" title='Miss Can' >
											<img className='carousel-card-img' src='../assets/img/miss_can.webp' alt='Miss Can: A Portuguese and family project of the canning industry with 3 generations of history and tradition. Canned food produced in Portugal, with Portuguese fish and artisanal.' />
											<div className='col gap-sm pad-md carousel-card-text'>
									...
									<li className='carousel-card'>
										<a className='col center' href='https://buzzvel.com/portfolio/thinkferidas' target='_blank' rel="noreferrer" title='ThinkFeridas' >
											<img className='carousel-card-img' src='../assets/img/thinkferidas.webp' alt='ThinkFeridas: ThinkFeridas is an application that responds to the need of many health professionals who work alone in the clinical decision regarding treating complex wounds.' />
											<div className='col gap-sm pad-md carousel-card-text'>
									...
									<li className='carousel-card'>
										<a className='col center' href='https://buzzvel.com/portfolio/vigias-da-arriba' target='_blank' rel="noreferrer" title='Vigias da Arriba' >
											<img className='carousel-card-img' src='../assets/img/vigias_da_arriba.webp' alt='Vigias da Arriba: Vigias da Arriba is a luxury, unique and exclusive condominium with several villas with a superb sea view. It is located in Torres Vedras.' />
											<div className='col gap-sm pad-md carousel-card-text'>
									...
									<li className='carousel-card'>
										<a className='col center' href='https://buzzvel.com/portfolio/portugal-advanced-health' target='_blank' rel="noreferrer" title='Portugual Advanced Health' >
											<img className='carousel-card-img' src='../assets/img/portugal_advanced_health.webp' alt='Portugual Advanced Health: Portugal Advanced Health or PAH is an innovative and pioneering project in the area of health in Portugal, specializing in hyperbaric treatments at 1.4atm (atmosphere).' />
											<div className='col gap-sm pad-md carousel-card-text'>
									...
									<li className='carousel-card'>
										<a className='col center' href='https://buzzvel.com/portfolio/hotspotty' target='_blank' rel="noreferrer" title='Hotspotty' >
											<img className='carousel-card-img' src='../assets/img/hotspotty.webp' alt='Hotspotty: An innovative "All-in-One" platform to plan, manage and optimize decentralized networks such as the global Helium network for the Internet of Things.' />
											<div className='col gap-sm pad-md carousel-card-text'>
